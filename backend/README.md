...
## Project Structure
    ...
    ├── testapiautostorybo_127608  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_127608`
...
2. Clone this repo and `cd testapiautostorybo_127608`
